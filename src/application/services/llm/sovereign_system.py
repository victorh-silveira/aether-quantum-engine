...
SOVEREIGN_SYSTEM = (
    ...
    "SAIDA OBRIGATORIA: unico objeto JSON com chaves EURUSD, US_CLUSTER, EU_CLUSTER, Probabilidade. "
    'Exemplo: {"EURUSD":"CALL","US_CLUSTER":"CALL","EU_CLUSTER":"PUT","Probabilidade":0.72}. '
    "EURUSD, US_CLUSTER e EU_CLUSTER: somente CALL ou PUT na saida (nunca RISE, FALL, WAIT, SKIP). "

...
SSOT operacional: [`config/settings.json`](../config/settings.json) — universo **`R_10`** (Volatility 10), contrato **3 m**, micro/MINI **180 s** (M3), ciclo **180 s**, macro **7200 s**. Metodologia: [`medallion.md`](medallion.md). Sample size: [`sample-size-lln.md`](sample-size-lln.md). Loss ML: [`infra-docker.md`](infra-docker.md) (`aether-loss-classifier`).

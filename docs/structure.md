...
| `feat/synthetic-indices-m5` | Indices sinteticos Deriv M1 (`R_100` + volatilidade) | Mesmo path `config/settings.json` com perfil sintetico; `docs/medallion-synthetic.md`, `docs/arquitetura-synthetic.md` |

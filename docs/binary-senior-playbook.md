...
| `neg_edge` | Edge Cal do lado &lt; `min_edge_execute` → **hard-skip** por padrao; soft se lado == vela fechada **e** edge >= `neg_edge_soft_min_edge` (**-0.12**); soft tambem sob FLIP `p_ovr` com o mesmo piso |

...
4. SCALE **retract/explos/tape adapt** (nao SKIP; last **exceto** FLIP sticky): retract/explos com mi+mili; explos so se Cal Edge TCN ≤ **0.05**; ou fita **forte** (`tape_strong`) → fixa EXEC; com FLIP → `flip_holds`; discordance so telemetria

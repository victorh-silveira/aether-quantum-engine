...
| `signal_skip.anti_loss_allow_candle_flip` | `orchestrator.execution.signal_skip` | **true** — EMA/candle discord → FLIP para lado da vela/ops (soft); Edge novo lado ≤0 → HARD neg_edge |

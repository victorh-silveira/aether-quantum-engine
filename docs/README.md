...
| [binary-senior-playbook.md](binary-senior-playbook.md) | Playbook trader senior: CALL/PUT/SKIP, catalogo gate_reason, knobs M3 (micro 180s) |
...
| [infra-docker.md](infra-docker.md) | Stack Docker hibrida: profiles `core/gpu/cpu/ml`, binds localhost, hydrate 180/7200, smoke |
...
| [deriv-indices-algorithm.md](deriv-indices-algorithm.md) | Universo `R_10` (Volatility 10 M3) e migracao |
...
| Histórico treino | **2000** barras micro M3; sync lean no treino (macro≤128, mini=0) |

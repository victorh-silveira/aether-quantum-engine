...
| Loss (`aether-loss-classifier`) | `127.0.0.1:8006` | `ml` | 512m | LGBMClassifier **24D**; buffer `learn_buffer.pkl`; T=2 se bootstrap ou `n_train < LOSS_YOUNG_TEMP_N` (**32**); motor **FLIP** so apos auto_learn; pe>=0.55 |

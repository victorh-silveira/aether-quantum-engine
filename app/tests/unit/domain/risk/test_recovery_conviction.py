...
def test_scaled_recovery_min_val_accuracy_ladder():
    assert scaled_recovery_min_val_accuracy({"recovery_min_val_accuracy": 0.53}, consecutive_losses=0) == 0.53
    assert scaled_recovery_min_val_accuracy({"recovery_min_val_accuracy": 0.53}, consecutive_losses=3) == 0.54
    assert scaled_recovery_min_val_accuracy({"recovery_min_val_accuracy": 0.53}, consecutive_losses=4) == 0.55

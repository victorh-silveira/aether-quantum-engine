...
def test_resolve_dlambert_force_explore_weak_f_star_without_cover_disabled():
    class RM:
        dlambert_unit = 110.0
        dlambert_config = {}
...
def test_resolve_dlambert_near_stop_keeps_cover_with_weak_f_star():
    class RM:
        dlambert_unit = 110.0
        dlambert_config = {}
        soft_recovery_config = {
    ...
    assert tag == "D'ALEMBERT"
    assert stake == pytest.approx(50.0 / 0.95, rel=1e-2)

...
def test_predict_symbol_decision_sync_cache_hit():
    """Verifica predicao DL sincrona local com reaproveitamento de cache."""
    orch = MagicMock()
    orch.config = {
        "deep_learning": {"enabled": True},
        "data_handler": {},
    ...
    cached_entry = {"direction": "CALL", "cached": True}
    with patch(
        "src.application.services.deep_learning.dl_predict.resolve_cached_prediction",

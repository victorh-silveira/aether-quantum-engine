...
def test_settlement_tolerance_window_and_backoff_defaults():
    assert resolve_settlement_tolerance_window(None, {}) == pytest.approx(600.0)
    assert resolve_settlement_tolerance_window(None, {"settlement_tolerance_window_seconds": 600}) == pytest.approx(
        600.0
    )

...
def test_micro_tail_stake_cap_and_max_safe_flatten_at_linear_four() -> None:
    ...
    assert max_safe_stake_cap(100.0, consecutive_losses_linear=0) == pytest.approx(2.50)
    ...
    assert max_safe_stake_cap(10000.0, consecutive_losses_linear=4) == pytest.approx(200.0)

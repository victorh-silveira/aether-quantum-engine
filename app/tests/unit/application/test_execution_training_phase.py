...
@pytest.mark.asyncio
async def test_execute_cluster_suspends_trading_during_training_phase(orch_config):
...
@pytest.mark.asyncio
async def test_execute_cluster_training_phase_dedupes_repeated_log(orch_config):
    orch = _build_orch(orch_config)

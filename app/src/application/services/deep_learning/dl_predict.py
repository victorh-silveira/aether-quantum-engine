...
def predict_symbol_decision(
    ...
    *,
    ...
    """Gera predicao DL sync; sob event loop exige force_local ou caminho async."""
    if force_local:
    ...
    raise RuntimeError(
        "DL: predict_symbol_decision sob event loop; use predict_symbol_decision_async ou force_local=True"
    )

...
BASE_FEATURE_DIM = _dl_feature_build.BASE_FEATURE_DIM
DERIV_FEATURE_DIM = _dl_feature_build.DERIV_FEATURE_DIM
FEATURE_DIM = _dl_feature_build.FEATURE_DIM
PAIR_FEATURE_DIM = _dl_feature_build.PAIR_FEATURE_DIM

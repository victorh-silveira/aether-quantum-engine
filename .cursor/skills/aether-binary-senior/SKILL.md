...
description: >-
  ...
  tecnico, or when the user mentions playbook senior, SKIP, V75, M15, ou binarias 1HZ75V.
---

# Playbook senior binario (`1HZ75V` / M15)

Ler `docs/binary-senior-playbook.md` e `docs/deriv-indices-algorithm.md`.

Universo: **Volatility 75 (1s) Index** (`1HZ75V`) — **M15** (contrato ops **15 m / M15**; label TCN **N=1 vela M15**; ciclo **900 s**; micro/MINI **900 s**; macro **86400 s**; ratio **1:96**).

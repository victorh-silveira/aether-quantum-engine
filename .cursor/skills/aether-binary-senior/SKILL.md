...
description: >-
  Avalia sessoes live no estilo trader senior de opcoes binarias M5
  (CALL/PUT/SKIP tecnico ou signal_skip 1.1; OHLC 300s) no indice
  1HZ75V (Volatility 75 (1s) Index). Use when analyzing CLUSTER/Cal/Edge logs, gate_reason
  tecnico, or when the user mentions playbook senior, SKIP, V75, M5, ou binarias 1HZ75V.
---
